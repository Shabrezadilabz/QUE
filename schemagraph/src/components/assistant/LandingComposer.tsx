        ...
        <div className="flex items-start gap-[12px] px-[20px] pb-[12px] pt-[20px]">
          ...
          <div className="min-w-0 flex-1">
            ...
            <textarea
              ...
              className="min-h-[72px] w-full resize-none border-none bg-transparent text-[18px] leading-relaxed text-[var(--pdf-text-primary)] outline-none placeholder:text-[var(--pdf-text-faint)] disabled:opacity-50"
            />
          </div>
        </div>
