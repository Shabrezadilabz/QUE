...
export function MonkPromptModal({
  ...
  return (
    ...
    >
      <div className="w-full max-w-lg rounded-lg border border-[#424850] bg-[#1a1f24] p-lg shadow-xl">
        <h2
        ...
        <p className="mt-sm font-body text-sm leading-relaxed text-[#aab5c0]">
        ...
        <p className="mt-sm font-body text-xs text-[#7a8694]">
